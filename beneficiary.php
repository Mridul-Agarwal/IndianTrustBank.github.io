<?php
    ...
    */include "connect.php";
    ...
    //if (isset($_SESSION['loggedIn_cust_id'])) {
        $sql0 = "SELECT * FROM customer WHERE cust_id!=".$_GET['cust_id'];
    //}
?>
...
<body>
    ...
    <div class="flex-container">
        <p id="info">Select from below customers to send money:-</p>
        <?php
                        ...
                        <div class="flex-item">
                            ...
                            <div class="flex-item-1">
                                ...
                                <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                    ...
                                    <a href="./send_funds.php?cust_id=<?=$row["cust_id"];?>&sender=<?=$_GET['cust_id'];?>">Send</a>
                                    <!--<a href="./delete_beneficiary.php?cust_id=<?php echo $row["cust_id"] ?>"
