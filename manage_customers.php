<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql0 = "SELECT cust_id, first_name, last_name, account_no, email, phone_no FROM customer";
    }
?>
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="flex-item">
                    ...
                    <div class="flex-item-2">
                        ...
                        <p id="email"><?php echo "Email ID : " . $row["email"]; ?></p>
                        <p id="phno"><?php echo "Phone No : " . $row["phone_no"]; ?></p>
                    </div>
                    <div class="flex-item-1">
                        <div class="dropdown">
                          ...
                          <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                            ...
                            <a href="./beneficiary.php?cust_id=<?php echo $row["cust_id"] ?>">Transfer Money</a>
