<?php
    ...
    $sql0 = "SELECT * FROM customer WHERE cust_id=".$sender_id." AND pwd='".md5($password)."'";
    ...
    if (($result0->num_rows) > 0) {
        $sql1 = "SELECT balance FROM passbook WHERE cust_id=".$sender_id." ORDER BY trans_id DESC LIMIT 1";
        ...
        if($updated_sender_balance >= 0) {
            $sql2 = "SELECT balance FROM passbook WHERE cust_id=".$receiver_id." ORDER BY trans_id DESC LIMIT 1";
            ...
            $sql3 = "INSERT INTO passbook VALUES(
                        NULL,
                        $sender_id,
                        NOW(),
            ...
            $sql4 = "INSERT INTO passbook VALUES(
                        NULL,
                        $receiver_id,
                        NOW(),
...
<body>
    <div class="flex-container">
        ...
        <div class="flex-item">
            <a href="./beneficiary.php?cust_id=<?=$sender_id;?>" class="button">Go Back</a>
        </div>
    </div>
